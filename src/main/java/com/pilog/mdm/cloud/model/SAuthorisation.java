...
import com.pilog.mdm.cloud.model.id.SAuthorisationId;
import lombok.Data;
...
@Data
public class SAuthorisation implements Serializable {
    @Column(name = "AUDIT_ID", length = 4000)
    private String auditId;

    @EmbeddedId
    @AttributeOverrides({@AttributeOverride(name = "persId", column = @Column(name = "PERS_ID", nullable = false)), @AttributeOverride(name = "passPhrase", column = @Column(name = "PASS_PHRASE", nullable = false, length = 600))})
