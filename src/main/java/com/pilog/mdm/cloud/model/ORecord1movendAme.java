...
import com.pilog.mdm.cloud.model.id.ORecord1movendAmeId;
import lombok.Data;
...
@Entity
@Table(name = "O_RECORD_1MOVEND_AME")
@Data
public class ORecord1movendAme implements Serializable {
    @EmbeddedId
    @AttributeOverrides({@AttributeOverride(name = "mandt", column = @Column(name = "MANDT", nullable = false, length = 120)), @AttributeOverride(name = "instance", column = @Column(name = "INSTANCE", nullable = false, length = 120)), @AttributeOverride(name = "lifnr", column = @Column(name = "LIFNR", nullable = false, length = 80)), @AttributeOverride(name = "reqNumber", column = @Column(name = "REQ_NUMBER", nullable = false, length = 240))})
    private ORecord1movendAmeId id;
